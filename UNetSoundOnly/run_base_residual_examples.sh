...
echo "  - Epochs 0-20:  High λ_base (learn structure)"
echo "  - Epochs 20+:   High λ_recon (refine accuracy)"
echo ""
...
echo ""
echo "Tuning guide:"
echo "  - ↑ lambda_base:   If base is too noisy"
echo "  - ↓ lambda_sparse: If residual too suppressed"
echo "  - ↑ lowpass_kernel: For larger rooms"
echo ""
...
echo "  → Decrease lambda_sparse (try 0.05 or 0.01)"
echo ""
echo "Problem: Residual is very large"
echo "  → Increase lambda_base (try 1.0 or 1.5)"
echo ""
echo "Problem: Base has sharp edges"
echo "  → Increase lowpass_kernel (try 12 or 16)"
echo ""
echo "Problem: Training unstable"
echo "  → Use --use_adaptive_loss"
echo ""
...
echo "  ✓ 20-30% faster convergence"
echo "  ✓ Better structure (straighter walls)"
echo "  ✓ Fewer artifacts in uniform regions"
echo "  ✓ Interpretable: can visualize learned layout"
echo ""
echo "Metrics:"
